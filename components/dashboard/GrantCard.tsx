...
export default function GrantCard({grantID, name, amount, description, createdDate}: {grantID: number, name: string, amount: number, description: string, createdDate: string}){
    ...
    return(
        <div className="flex flex-col justify-between border-2 border-neutral-400 px-4 py-4 rounded-lg 2xl:w-[28rem] w-[20rem] 2xl:mr-6 mr-6 2xl:my-4 my-3 group hover:text-darkmaroon hover:border-darkmaroon transition duration-500">
            <div className="">
