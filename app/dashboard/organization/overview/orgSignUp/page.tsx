...
export default function OrgSignUpPage() {
    ...
    const createOrg = async () => {
        ...
        setLoading(true);
        await createOrganization(orgName, orgEmail, orgBio, orgWebsite, orgType).then(()=>{
            displaySuccessToast(); 
            location.reload();
            router.push("/dashboard/organization/overview");
    ...
    return(
        ...
        <div className="bg-lightmaroon/20 2xl:w-[60rem] w-[50rem] 2xl:mt-14 mt-6 rounded-lg 2xl:px-14 px-10 2xl:py-14 py-6 2xl:text-lg animate-in">
            ...
            <textarea className="bg-primary rounded-md focus:outline-none 2xl:w-1/2 w-3/5 px-2 2xl:py-2 py-1 min-h-[5rem] text-base" placeholder="Tell us a little about your organization" onChange={e => setOrgBio(e.target.value)}/>
