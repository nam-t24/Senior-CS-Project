...
export default function CreateGrant() {
    ...
    return (
      <div className="">
        <PageHeading
          header="Create Grant"
          description="Create a new grant for organizations to apply to"
        />

        <Link
          href="/dashboard/organization/grants"
          className="flex items-center 2xl:mt-8 mt-6 2xl:text-lg animate-in"
        >
          <ChevronLeftIcon />
          Go back to grants
        </Link>
        ...
        <div className="border-2 border-gray-200 w-[50rem] rounded-lg mx-auto mt-8 py-8 px-16 bg-[#FFFEFE] animate-in shadow">
          ...
          >
            {submitting ? "Creating new grant..." : "Create New Grant"}
          </button>
        </div>
      </div>
    );
