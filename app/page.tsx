  ...
  return (
    <div className="2xl:bg-[url('/assets/backgrounds/homeBG_desktop.svg')] bg-[url('/assets/backgrounds/homeBG_laptop.svg')] bg-cover bg-center bg-no-repeat min-h-screen min-w-full relative flex justify-center items-center">
      ...
      <div className="absolute top-0 w-screen 2xl:h-28 h-20 flex flex-row text-wrap">
        ...
        {/* Header Tabs */}
        <div className="2xl:px-40 px-20 2xl:space-x-20 space-x-12 flex flex-row text-2xl text-heading items-center">
        ...
        <div className="flex flex-row flex-1 text-heading justify-end items-center">
          {email && <div className="2xl:pr-10 pr-6 text-xl font-medium">Hey, {email}!</div>}
          {email ?
          <Link href="/dashboard" className="2xl:mr-10 mr-6 2xl:h-16 h-12 2xl:w-40 w-32 border-4 border-darkmaroon border-solid rounded-full text-darkmaroon 2xl:text-xl text-lg font-semibold flex justify-center items-center hover:bg-darkmaroon hover:text-primary transition duration-300">Dashboard</Link>
          :
          <Link href="/login" className="2xl:mr-10 mr-6 2xl:h-16 h-12 2xl:w-40 w-32 border-4 border-darkmaroon border-solid rounded-full text-darkmaroon 2xl:text-xl text-lg font-semibold flex justify-center items-center hover:bg-darkmaroon hover:text-primary transition duration-300">Log In</Link>
          }
        </div>
      </div>

      {/* Center Text */}
      <div className="relative space-y-8 flex flex-col text-center">
