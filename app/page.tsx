    ...
    <div className="2xl:bg-[url('/assets/backgrounds/homeBG_desktop.svg')] bg-[url('/assets/backgrounds/homeBG_laptop.svg')] bg-cover bg-center bg-no-repeat min-h-screen min-w-full relative flex justify-center items-center">
      ...
      <div className="absolute top-0 w-screen 2xl:h-28 h-20 flex flex-row text-wrap">
        ...
        <div className="2xl:pl-40 pl-20 2xl:space-x-20 space-x-12 flex flex-1 text-2xl text-heading items-center">
          <Link href="/about" className="hover:text-darkmaroon transition duration-300">About</Link>
          <Link href="/how_it_works" className="hover:text-darkmaroon transition duration-300">How It Works</Link>
          <Link href="/why_minted" className="hover:text-darkmaroon transition duration-300">Why Minted</Link>
        </div>
        {/* Log in/out Button */}
        <div className="flex flex-1 justify-end">
          <button className="2xl:mt-6 mt-4 2xl:mr-10 mr-6 2xl:h-16 h-12 2xl:w-40 w-32 border-4 border-darkmaroon border-solid rounded-full text-darkmaroon hover:bg-darkmaroon hover:text-primary transition duration-300">
            <Link href="/login" className="2xl:text-xl text-lg font-semibold">Log In</Link>
          </button>
        </div>
      </div>
